...
public class UpdateMovieRequest
{
    ...
    /// 导演Id
    /// </summary>
    [JsonPropertyName("director_id")] public string DirectorId { get; set; } = String.Empty;

    /// <summary>
    /// 演员Id
    /// </summary>
    [JsonPropertyName("actor_ids")] public List<string> ActorIds { get; set; } = new List<string>();
}